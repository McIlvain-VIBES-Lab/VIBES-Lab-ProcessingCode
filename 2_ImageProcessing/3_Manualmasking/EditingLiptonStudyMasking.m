...
save t2mask_final_remask.mat mask
...
mreParams.subj = 'mre_for_inversion_remask';
...
save(sprintf('%s_remask.mat',SubjectName),'mreParams','mask','Zmotion','Ymotion','Xmotion','t2stack','OSS_SNR')
