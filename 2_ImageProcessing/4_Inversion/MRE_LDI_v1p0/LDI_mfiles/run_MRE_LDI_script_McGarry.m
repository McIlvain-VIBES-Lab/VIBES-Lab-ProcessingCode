...
P=P(userow,usecol,useslice,:,:); cropmask=mask(userow,usecol,useslice);cropnanmask=nanmask(userow,usecol,useslice);
...
outfilename = run_LDI_fun(fitkernel,Delta,smoothfilter,nanfract, LDIdir, fitinputfilename)
