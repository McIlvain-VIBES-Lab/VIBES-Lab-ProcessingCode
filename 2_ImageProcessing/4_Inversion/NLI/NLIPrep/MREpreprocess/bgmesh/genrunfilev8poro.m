...
fprintf(fid,' 4000.d0, 1.d-8, 4300.d0, 1.d-4, -7.d0, -24.d0, 0.2d0, 1.d-4\n');
...
fprintf(fid,'0.0050000 , 0.0050000 , 0.0050000 \n');
...
fprintf(fid,'Zone Iteration Structures [<# of CG iters> <# of GN iters> <# of line search iters>]: \n');
fprintf(fid,'0,0,1,1 \n');
fprintf(fid,'0,0,2,2 \n');
fprintf(fid,'0,0,3,2 \n');
...
fprintf(fid,'.false.,.true.,.false.,.false.,.false.,.true.,.true.,.true.,.true.,.false. \n');
...
fprintf(fid,'0.004d0,0.004d0,0.008d0,0.004d0 \n');
fprintf(fid,'0.004d0,0.004d0,0.004d0,0.004d0 \n');
fprintf(fid,'SF Final Gaussian width: <1st line real, 2nd line imag> \n');
fprintf(fid,'0.002d0,0.002d0,0.004d0,0.002d0 \n');
fprintf(fid,'0.002d0,0.002d0,0.002d0,0.002d0 \n');
...
fprintf(fid2, 'mpirun -np $nprocs /ihome/lsolamen/code/MREv8/MRE-Zone.mp2 runfile_v8poro.dat\n');
fprintf(fid2,'exit 0  \n');
fclose(fid2);
