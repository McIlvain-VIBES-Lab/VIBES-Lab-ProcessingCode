...
cd MRE; cd AP 
%addpath('PostInv')
load Mu.mat; load slowfasttwo.mat; load BuckyOut.mat; load Mu_LDI_Diff.mat
...
save('Quant_MUFS_APnewall.mat','TotalAP','MutotlistAP','ThlistAP','FAtractlistAP')

%% LR
cd ..; cd LR
%addpath('PostInv')
load slowfasttwo.mat; load BuckyOut.mat; load Mu_LDI_Diff.mat
load Mu.mat
...
save('Quant_MUFS_LRnewall.mat','TotalLR','UperctotLR','MutotlistLR','ThlistLR','FAtractlistLR','AmplistLR')
