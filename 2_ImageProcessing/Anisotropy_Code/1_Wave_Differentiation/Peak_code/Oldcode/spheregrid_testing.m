function [Mat_full,peaks_mat,peak_data_mat] = spheregrid_testing(Bifo_all,Brfo_all,mask)
tic
...
%                 Mult_norm(i1,j1,k1,:) = reshape(Mult/EnerU3(i1,j1,k1),[1 1 1 length(Mult)]);
                ...
                % [peaks_loc,num_peaks] = peakfinder(Sphmat,BW2);
                [peak_data] = peakfinder4(matrix,N,maxpeaks);
                peaks = peak_data(:,3);
...
%save('Peaks_Output_twinpeaks.mat','peaks_mat','peak_number','peak_data_mat','Mat_full','-v7.3')
