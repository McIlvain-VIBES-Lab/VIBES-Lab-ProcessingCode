...
!$FSLDIR/bin/flirt -in DTI.nii -ref t2bet.nii -o Diff_rotated.nii -applyxfm -init dti2mre.mat
...
!$FSLDIR/bin/dtifit -k Diff_rotated.nii -o dti_rot -m dti_mask.nii -r Diff_rotated.bvec -b Diff.bval -V
