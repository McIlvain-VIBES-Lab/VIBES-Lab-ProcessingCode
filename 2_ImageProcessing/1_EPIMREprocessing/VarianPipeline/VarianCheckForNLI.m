...
system(['bash /Volumes/McIlvainDrive2/VIBES-Lab-ProcessingCode/2_ImageProcessing/1_EPIMREprocessing/Teah_test/nli_pull_varian.sh'])
    ...
    try
        ...
        if exist(needNLI_file, 'file') && ~exist(postNLI_file, 'file')
            ...
            cd('NLI_Outputs')
                ...
                %TS added 56-93 on May 1 movefile(SubjectName,
                %'NLI_Outputs');
                cd ..
                mkdir('Nifti_Data');
