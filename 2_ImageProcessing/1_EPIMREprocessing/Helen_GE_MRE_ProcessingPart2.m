function [mreParams,mask,Zmotion,Ymotion,Xmotion,t2stack,OSS_SNR]= Helen_GE_MRE_ProcessingPart2(phsimg,t2stack,t2bet, mask,dx,dy,dz,freq, mask_label)
...
% main mod: 
% step 1: the mask supplied is actually "maskx" 
maskx = mask;
% step 2: load the t2bet mat file
t2bet = t2bet.mask;
% step 3: calculate for the correct mask 
mask = t2bet.*abs(1-maskx);
% step 4: save correct final mat 
