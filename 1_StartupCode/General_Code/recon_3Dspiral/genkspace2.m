function [kx,ky,gx,gy] = genkspace2(FOV,N,ld,nint,gamp,gslew,tsamp,rotamount,rev_flag,gts,flag_vd,int_rotation,alpha_vd);
...
% COPIED AND MODIFIED BY CHAS CONWAY (5-11-09) TO SILENCE OUTPUT
...
%dts = 4e-6;    %5e-6
if (flag_vd == 1)
  [Gx,Gy,kxi,kyi,sx,sy] = genspivd_Kim2(FOV,N,nint,gamp,gslew,gts,alpha_vd);
  %keyboard
else
