 function xs = qpwls_pcg_largeIter(x, G, W, yi, nder1, C, M, niter, mask, chat)
...
%
% Modified June26, 2013 by Joe Holtrop for use with very high number of
% iteratios
%   only the last iteration is stored and outputed, no other info is stored
